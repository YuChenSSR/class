...
class MultiCtrlCompiler(BaseCompiler):
    ...
    def run(
        ...
        layout_heuristic (str | None):
            Ablation hook: heuristic used by the *layout* stage only
            ("decay" | "dqcmap" | "dm1"). None (default) keeps the historical
            behavior of using ``heuristic`` for both layout and routing.
        """
